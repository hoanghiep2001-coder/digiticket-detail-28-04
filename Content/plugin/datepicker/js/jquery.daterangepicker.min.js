...
(function(factory) {
   ...
   $.fn.dateRangePicker = function(opt) {
       ...
       function showMonth(date, month) {
           ...
           box.find('.' + month + ' .month-name').html(`<div class="custom-title-daterange">${dateRangeTitleCustom} ${monthElement}/${yearElement}</div>`);
       ...
       function generateMonthElement(date, month) {
           ...
           var nonSelectableMonth = currentMonthName;
       ...
       function generateYearElement(date, month) {
           ...
           var nonSelectableMonth = currentYear;
